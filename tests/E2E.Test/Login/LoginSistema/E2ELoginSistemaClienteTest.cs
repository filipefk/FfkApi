...
namespace Aceitacao.Test.Login.LoginSistema;

[TestFixture]
[Parallelizable(ParallelScope.All)]
public class E2ELoginSistemaClienteTest : E2EClassFixture
{
    ...
    public async Task Sucesso()
    {
        ...
        var sistemaClienteNovo = await CadastroHelper.CadastrarNovoSistemaCliente();

        var request = RequestLoginSistemaClienteBuilder.Build(sistemaClienteNovo);
        ...
        Assert.That(name, Is.EqualTo(sistemaClienteNovo.Nome));
