...
public class E2EPegarDadosAnexoTest : E2EClassFixture
{
    ...
    public async Task Sucesso_Administrador()
    {
        ...
        var response = await HttpHelper.DoGet($"{_baseUrlAnexo}/{anexo.Id}", cancellationToken, token);
    ...
    public async Task Erro_Anexo_Nao_Encontrado()
    {
        ...
        var response = await HttpHelper.DoGet($"{_baseUrlAnexo}/{Guid.NewGuid()}", cancellationToken, token);
    ...
    public async Task Erro_Token_Invalido()
    {
        ...
        var response = await HttpHelper.DoGet($"{_baseUrlAnexo}/{Guid.NewGuid()}", cancellationToken, "tokenInvalid");
    ...
    public async Task Erro_Id_Invalido(string id)
    {
        ...
        var response = await HttpHelper.DoGet(url: $"{_baseUrlAnexo}/{id}", cancellationToken: cancellationToken, token: token);
    ...
    public async Task Erro_Sem_Token()
    {
        ...
        var response = await HttpHelper.DoGet($"{_baseUrlAnexo}/{Guid.NewGuid()}", cancellationToken);
    ...
    public async Task Erro_App_Token_Ausente()
    {
        ...
        var response = await HttpHelper.DoGet($"{_baseUrlAnexo}/{Guid.NewGuid()}", cancellationToken, token, addAppToken: false);
    ...
    public async Task Erro_App_Token_Invalido()
    {
        ...
        var response = await HttpHelper.DoGet($"{_baseUrlAnexo}/{Guid.NewGuid()}", cancellationToken, token, appToken: "app-token-invalido");
