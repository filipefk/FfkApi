...
namespace Aceitacao.Test.Anexo.Pegar;

[TestFixture]
[Parallelizable(ParallelScope.All)]
public class E2EPegarArquivoAnexoTest : E2EClassFixture
{
    ...
    public async Task Erro_Token_Invalido()
    {
        ...
        var response = await HttpHelper.DoGet($"{_baseUrlAnexoArquivo}/{Guid.NewGuid()}", cancellationToken, "tokenInvalid");
    ...
    public async Task Erro_Sem_Token()
    {
        ...
        var response = await HttpHelper.DoGet($"{_baseUrlAnexoArquivo}/{Guid.NewGuid()}", cancellationToken);
    ...
    public async Task Erro_App_Token_Ausente()
    {
        ...
        var response = await HttpHelper.DoGet($"{_baseUrlAnexoArquivo}/{Guid.NewGuid()}", cancellationToken, token, addAppToken: false);
    ...
    public async Task Erro_App_Token_Invalido()
    {
        ...
        var response = await HttpHelper.DoGet($"{_baseUrlAnexoArquivo}/{Guid.NewGuid()}", cancellationToken, token, appToken: "app-token-invalido");
