...
namespace Aceitacao.Test.Anexo.Pesquisar;

[TestFixture]
[Parallelizable(ParallelScope.All)]
public class E2EPesquisarAnexoTest : E2EClassFixture
{
    ...
    {
        return _queryTest.Replace("{nome-arquivo}", anexo.NomeArquivo).Replace("{tamanho}", anexo.TamanhoBytes.ToString());
    }
    ...
    public async Task Sucesso_Administrador()
    {
        ...
        var anexo = await CadastroHelper.CadastrarNovoAnexo();

        var query = AjustaQuery(anexo);
    ...
    public async Task Erro_Token_Invalido()
    {
        ...
        var query = _queryTest.Replace("nome-arquivo", "Nomequalquer.png").Replace("{tamanho}", "123");
