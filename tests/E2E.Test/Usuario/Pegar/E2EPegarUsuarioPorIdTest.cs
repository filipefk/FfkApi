...
public class E2EPegarUsuarioPorIdTest : E2EClassFixture
{
    ...
    public async Task Erro_Token_Invalido()
    {
        ...
        var response = await HttpHelper.DoGet($"{_baseUrlUsuario}/{_usuarioAdministrador.Id}", cancellationToken, "tokenInvalid");
    ...
    public async Task Erro_Sem_Token()
    {
        ...
        var response = await HttpHelper.DoGet($"{_baseUrlUsuario}/{_usuarioAdministrador.Id}", cancellationToken);
    ...
    public async Task Erro_Token_De_Usuario_Nao_Encontrado()
    {
        ...
        var response = await HttpHelper.DoGet($"{_baseUrlUsuario}/{_usuarioAdministrador.Id}", cancellationToken, token);
