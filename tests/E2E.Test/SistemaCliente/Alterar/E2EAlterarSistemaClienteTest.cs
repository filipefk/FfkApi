...
namespace Aceitacao.Test.SistemaCliente.Alterar;

[TestFixture]
[Parallelizable(ParallelScope.All)]
public class E2EAlterarSistemaClienteTest : E2EClassFixture
{
    ...
    public async Task Sucesso_Administrador()
    {
        ...
        request.Id = sistemaCliente.Id.ToString();

        var response = await HttpHelper.DoPut(url: _baseUrlSistemaCliente, request: request, token: token, cancellationToken: cancellationToken);
    ...
    public async Task Erro_Sem_Token()
    {
        ...
        var response = await HttpHelper.DoPut(url: _baseUrlSistemaCliente, cancellationToken: cancellationToken, request: request);
    ...
    public async Task Erro_Token_Invalido()
    {
        ...
        var response = await HttpHelper.DoPut(url: _baseUrlSistemaCliente, cancellationToken: cancellationToken, request: request, token: "TokenInvalido");
    ...
    public async Task Erro_Token_De_Usuario_Nao_Encontrado()
    {
        ...
        var response = await HttpHelper.DoPut(url: _baseUrlSistemaCliente, cancellationToken: cancellationToken, request: request, token: token);
    ...
    public async Task Erro_App_Token_Ausente()
    {
        ...
        var response = await HttpHelper.DoPut(url: _baseUrlSistemaCliente, request: request, token: token, cancellationToken: cancellationToken, addAppToken: false);
    ...
    public async Task Erro_App_Token_Invalido()
    {
        ...
        var response = await HttpHelper.DoPut(url: _baseUrlSistemaCliente, request: request, token: token, cancellationToken: cancellationToken, appToken: "app-token-invalido");
    ...
    public async Task Erro_AppId_Ja_Existe()
    {
        ...
        var sistemaCliente1 = await CadastroHelper.CadastrarNovoSistemaCliente();
        var sistemaCliente2 = await CadastroHelper.CadastrarNovoSistemaCliente();

        var request = RequestAlterarSistemaClienteBuilder.Build();
        request.Id = sistemaCliente1.Id.ToString();
        request.AppId = sistemaCliente2.AppId.ToString();
        ...
        var mensagemEsperada = MessagesException.GetString("APP_ID_JA_EXISTE"); ;
