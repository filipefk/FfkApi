...
namespace Aceitacao.Test.SistemaCliente.Pegar;

[TestFixture]
[Parallelizable(ParallelScope.All)]
public class E2EPegarSistemaClienteTest : E2EClassFixture
{
    ...
    public async Task Sucesso_Administrador()
    {
        ...
        var response = await HttpHelper.DoGet($"{_baseUrlSistemaCliente}/{sistemaCliente.Id}", cancellationToken, token);
    ...
    public async Task Erro_Token_Invalido()
    {
        ...
        var response = await HttpHelper.DoGet($"{_baseUrlSistemaCliente}/{Guid.NewGuid()}", cancellationToken, "tokenInvalid");
    ...
    public async Task Erro_Sem_Token()
    {
        ...
        var response = await HttpHelper.DoGet($"{_baseUrlSistemaCliente}/{Guid.NewGuid()}", cancellationToken);
    ...
    public async Task Erro_App_Token_Ausente()
    {
        ...
        var response = await HttpHelper.DoGet($"{_baseUrlSistemaCliente}/{sistemaCliente.Id}", cancellationToken, token, addAppToken: false);
    ...
    public async Task Erro_App_Token_Invalido()
    {
        ...
        var response = await HttpHelper.DoGet($"{_baseUrlSistemaCliente}/{sistemaCliente.Id}", cancellationToken, token, appToken: "app-token-invalido");
