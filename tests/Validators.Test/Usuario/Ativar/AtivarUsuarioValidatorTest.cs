...
namespace UnidadeValidators.Test.Usuario.Ativar;

[TestFixture]
[Parallelizable(ParallelScope.All)]
public class AtivarUsuarioValidatorTest
{
    [Test]
    public void Sucesso()
    {
        ...
        var request = RequestAtivarUsuarioBuilder.Build();
    ...
    public void Erro_Senha_Invalida(int passwordLength)
    {
        ...
        var request = RequestAtivarUsuarioBuilder.Build(passwordLength: passwordLength);
