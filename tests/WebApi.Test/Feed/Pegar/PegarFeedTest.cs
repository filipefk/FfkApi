...
namespace Integracao.Test.Feed.Pegar;

[TestFixture]
[Parallelizable(ParallelScope.All)]
public class PegarFeedTest : FfkApiClassFixture
{
    ...
    public async Task Erro_Token_Invalido()
    {
        ...
        var response = await HttpHelper.DoGet($"{_baseUrlFeed}/{_feedNovo.Id}", cancellationToken, "tokenInvalid");
    ...
    public async Task Erro_Sem_Token()
    {
        ...
        var response = await HttpHelper.DoGet($"{_baseUrlFeed}/{_feedNovo.Id}", cancellationToken);
    ...
    public async Task Erro_App_Token_Ausente()
    {
        ...
        var response = await HttpHelper.DoGet($"{_baseUrlFeed}/{_feedNovo.Id}", cancellationToken, token, addAppToken: false);
    ...
    public async Task Erro_App_Token_Invalido()
    {
        ...
        var response = await HttpHelper.DoGet($"{_baseUrlFeed}/{_feedNovo.Id}", cancellationToken, token, appToken: "app-token-invalido");
