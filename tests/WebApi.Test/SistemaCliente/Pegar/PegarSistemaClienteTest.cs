...
namespace Integracao.Test.SistemaCliente.Pegar;

[TestFixture]
[Parallelizable(ParallelScope.All)]
public class PegarSistemaClienteTest : FfkApiClassFixture
{
    ...
    public PegarSistemaClienteTest()
    {
    ...
    public async Task Sucesso_Administrador()
    {
        ...
        var response = await HttpHelper.DoGet($"{_baseUrlSistemaCliente}/{_sistemaClienteNovo.Id}", cancellationToken, token);
    ...
    public async Task Erro_SistemaCliente_Nao_Encontrado()
    {
        ...
        var response = await HttpHelper.DoGet($"{_baseUrlSistemaCliente}/{Guid.NewGuid()}", cancellationToken, token);
    ...
    public async Task Erro_Token_Invalido()
    {
        ...
        var response = await HttpHelper.DoGet($"{_baseUrlSistemaCliente}/{_sistemaClienteNovo.Id}", cancellationToken, "tokenInvalid");
    ...
    public async Task Erro_Id_Invalido(string id)
    {
        ...
        var response = await HttpHelper.DoGet(url: $"{_baseUrlSistemaCliente}/{id}", cancellationToken: cancellationToken, token: token);
    ...
    public async Task Erro_Sem_Token()
    {
        ...
        var response = await HttpHelper.DoGet($"{_baseUrlSistemaCliente}/{_sistemaClienteNovo.Id}", cancellationToken);
    ...
    public async Task Erro_App_Token_Ausente()
    {
        ...
        var response = await HttpHelper.DoGet($"{_baseUrlSistemaCliente}/{_sistemaClienteNovo.Id}", cancellationToken, token, addAppToken: false);
    ...
    public async Task Erro_App_Token_Invalido()
    {
        ...
        var response = await HttpHelper.DoGet($"{_baseUrlSistemaCliente}/{_sistemaClienteNovo.Id}", cancellationToken, token, appToken: "app-token-invalido");
