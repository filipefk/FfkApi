...
namespace Integracao.Test.SistemaCliente.Excluir;

[TestFixture]
[Parallelizable(ParallelScope.All)]
public class ExcluirSistemaClienteTest : FfkApiClassFixture
{
    ...
    public ExcluirSistemaClienteTest()
    {
        ...
        _sistemaClienteNovo = (FfkApi.Domain.Entities.SistemaCliente)entidades["SistemaClienteNovo"];
    }
    ...
    public async Task Sucesso_Administrador()
    {
        ...
        var sistemaCliente = await CadastroHelper.CadastrarNovoSistemaCliente(_usuarioAdministrador.Id);

        var response = await HttpHelper.DoGet(url: $"{_baseUrlSistemaCliente}/{sistemaCliente.Id}", token: token, cancellationToken: cancellationToken);

        Assert.That(response.StatusCode, Is.EqualTo(HttpStatusCode.OK));

        response = await HttpHelper.DoDelete(url: $"{_baseUrlSistemaCliente}/{sistemaCliente.Id}", token: token, cancellationToken: cancellationToken);

        Assert.That(response.StatusCode, Is.EqualTo(HttpStatusCode.NoContent));

        response = await HttpHelper.DoGet(url: $"{_baseUrlSistemaCliente}/{sistemaCliente.Id}", token: token, cancellationToken: cancellationToken);
    ...
    public async Task Erro_SistemaCliente_Nao_Encontrado()
    {
        ...
        var response = await HttpHelper.DoDelete(url: $"{_baseUrlSistemaCliente}/{Guid.NewGuid()}", token: token, cancellationToken: cancellationToken);
    ...
    public async Task Erro_Token_Invalido()
    {
        ...
        var response = await HttpHelper.DoDelete($"{_baseUrlSistemaCliente}/{_sistemaClienteNovo.Id}", cancellationToken, "tokenInvalid");
    ...
    public async Task Erro_Id_Invalido(string id)
    {
        ...
        var response = await HttpHelper.DoDelete(url: $"{_baseUrlSistemaCliente}/{id}", cancellationToken: cancellationToken, token: token);
    ...
    public async Task Erro_Sem_Token()
    {
        ...
        var response = await HttpHelper.DoDelete($"{_baseUrlSistemaCliente}/{_sistemaClienteNovo.Id}", cancellationToken);
    ...
    public async Task Erro_Token_De_Usuario_Nao_Encontrado()
    {
        ...
        var response = await HttpHelper.DoDelete($"{_baseUrlSistemaCliente}/{_sistemaClienteNovo.Id}", cancellationToken, token);
    ...
    public async Task Erro_App_Token_Ausente()
    {
        ...
        var response = await HttpHelper.DoDelete(url: $"{_baseUrlSistemaCliente}/{_sistemaClienteNovo.Id}", token: token, cancellationToken: cancellationToken, addAppToken: false);
    ...
    public async Task Erro_App_Token_Invalido()
    {
        ...
        var response = await HttpHelper.DoDelete(url: $"{_baseUrlSistemaCliente}/{_sistemaClienteNovo.Id}", token: token, cancellationToken: cancellationToken, appToken: "app-token-invalido");
