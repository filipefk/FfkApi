...
namespace Integracao.Test.SistemaCliente.Pesquisar;

[TestFixture]
[Parallelizable(ParallelScope.All)]
public class PesquisarSistemaClienteTest : FfkApiClassFixture
{
    ...
    public PesquisarSistemaClienteTest()
    {
    ...
    public async Task Sucesso_Administrador()
    {
        ...
        var query = AjustaQuery(_sistemaClienteNovo);
