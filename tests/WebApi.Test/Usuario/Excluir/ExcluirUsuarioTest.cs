...
namespace Integracao.Test.Usuario.Excluir;

[TestFixture]
[Parallelizable(ParallelScope.All)]
public class ExcluirUsuarioTest : FfkApiClassFixture
{
    ...
    private readonly FfkApi.Domain.Entities.Usuario _usuarioExcluir1;
    private readonly FfkApi.Domain.Entities.Usuario _usuarioExcluir2;
    private readonly FfkApi.Domain.Entities.Usuario _usuarioExcluir3;
    ...
    public ExcluirUsuarioTest()
    {
        ...
        _usuarioExcluir1 = (FfkApi.Domain.Entities.Usuario)entidades["UsuarioExcluir1"];
        _usuarioExcluir2 = (FfkApi.Domain.Entities.Usuario)entidades["UsuarioExcluir2"];
        _usuarioExcluir3 = (FfkApi.Domain.Entities.Usuario)entidades["UsuarioExcluir3"];
    }
    ...
    public async Task Sucesso_Administrador()
    {
        ...
        var response = await HttpHelper.DoDelete($"{_baseUrlUsuario}/{_usuarioExcluir1.Id}", cancellationToken, token);

        Assert.That(response.StatusCode, Is.EqualTo(HttpStatusCode.NoContent));

        response = await HttpHelper.DoGet($"{_baseUrlUsuario}/{_usuarioExcluir1.Id}", cancellationToken, token);
    ...
    public async Task Sucesso_Usuario_Com_Permissao()
    {
        ...
        var response = await HttpHelper.DoDelete($"{_baseUrlUsuario}/{_usuarioExcluir2.Id}", cancellationToken, token);

        Assert.That(response.StatusCode, Is.EqualTo(HttpStatusCode.NoContent));

        response = await HttpHelper.DoGet($"{_baseUrlUsuario}/{_usuarioExcluir2.Id}", cancellationToken, token);
    ...
    public async Task Erro_Usuario_Ja_Excluido()
    {
        ...
        var response = await HttpHelper.DoDelete(url: $"{_baseUrlUsuario}/{_usuarioExcluir3.Id}", cancellationToken: cancellationToken, token: token);

        Assert.That(response.StatusCode, Is.EqualTo(HttpStatusCode.NoContent));

        response = await HttpHelper.DoDelete(url: $"{_baseUrlUsuario}/{_usuarioExcluir3.Id}", cancellationToken: cancellationToken, token: token);
    ...
    public async Task Erro_Auto_Exclusao()
    {
        ...
        var response = await HttpHelper.DoDelete(url: $"{_baseUrlUsuario}/{_usuarioPermissaoCadastroUsuarios.Id}", cancellationToken: cancellationToken, token: token);
    ...
    public async Task Erro_Token_Invalido()
    {
        ...
        var response = await HttpHelper.DoDelete($"{_baseUrlUsuario}/{_usuarioSemPerfilNemPermissao.Id}", cancellationToken, "tokenInvalid");
    ...
    public async Task Erro_Sem_Token()
    {
        ...
        var response = await HttpHelper.DoDelete($"{_baseUrlUsuario}/{_usuarioSemPerfilNemPermissao.Id}", cancellationToken);
    ...
    public async Task Erro_Token_De_Usuario_Nao_Encontrado()
    {
        ...
        var response = await HttpHelper.DoDelete($"{_baseUrlUsuario}/{_usuarioSemPerfilNemPermissao.Id}", cancellationToken, token);
