...
namespace Integracao.Test.Equipe.Cadastrar;

[TestFixture]
[Parallelizable(ParallelScope.All)]
public class CadastrarEquipeTest : FfkApiClassFixture
{
    ...
    public async Task Sucesso_Usuario_Com_Permissao_Sem_Informar_Organizacao()
    {
        ...
        request.Membros = [RequestMembroEquipeBuilder.Build(_usuarioPermissaoCadastroEquipes, true), RequestMembroEquipeBuilder.Build(_usuarioSemPerfilNemPermissao, false)];
        ...
        request.Organizacao = _usuarioPermissaoCadastroEquipes.Organizacao.Nome;
        AssertDadosDaRespostaComRequest(dadosDaResposta, request);
    }
