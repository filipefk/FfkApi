...
namespace Integracao.Test.Organizacao.CadastrarEmLote;

[TestFixture]
[Parallelizable(ParallelScope.All)]
public class CadastrarOrganizacaoEmLoteTest : FfkApiClassFixture
{
    ...
    public CadastrarOrganizacaoEmLoteTest()
    {
    ...
    public async Task Falha_Total()
    {
        ...
        requestNomeJaExiste!.Nome = _organizacaoNova.Nome;
        ...
        var responseErroQueRequestNomeJaExiste = responseObj.Erros
            .FirstOrDefault(e => e.Request.Nome == _organizacaoNova.Nome);
