...
namespace Integracao.Test.Organizacao.Cadastrar;

[TestFixture]
[Parallelizable(ParallelScope.All)]
public class CadastrarOrganizacaoTest : FfkApiClassFixture
{
    ...
    public CadastrarOrganizacaoTest()
    {
    ...
    public async Task Erro_Nome_Organizacao_Ja_Existe()
    {
        ...
        var request = RequestCadastrarOrganizacaoBuilder.Build();
        request.Nome = _organizacaoFfkApi.Nome;
