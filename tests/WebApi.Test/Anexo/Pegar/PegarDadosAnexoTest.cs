...
public class PegarDadosAnexoTest : FfkApiClassFixture
{
    ...
    public async Task Sucesso_Administrador()
    {
        ...
        var response = await HttpHelper.DoGet($"{_baseUrlAnexo}/{_anexoNovo.Id}", cancellationToken, token);
    ...
    public async Task Erro_Token_Invalido()
    {
        ...
        var response = await HttpHelper.DoGet($"{_baseUrlAnexo}/{_anexoNovo.Id}", cancellationToken, "tokenInvalid");
    ...
    public async Task Erro_Sem_Token()
    {
        ...
        var response = await HttpHelper.DoGet($"{_baseUrlAnexo}/{_anexoNovo.Id}", cancellationToken);
    ...
    public async Task Erro_App_Token_Ausente()
    {
        ...
        var response = await HttpHelper.DoGet($"{_baseUrlAnexo}/{_anexoNovo.Id}", cancellationToken, token, addAppToken: false);
    ...
    public async Task Erro_App_Token_Invalido()
    {
        ...
        var response = await HttpHelper.DoGet($"{_baseUrlAnexo}/{_anexoNovo.Id}", cancellationToken, token, appToken: "app-token-invalido");
