...
namespace Integracao.Test.Anexo.Excluir;

[TestFixture]
public class ExcluirAnexoTest : FfkApiClassFixture
{
    ...
    public async Task Erro_Token_Invalido()
    {
        ...
        var response = await HttpHelper.DoDelete($"{_baseUrlAnexo}/{_anexoNovo.Id}", cancellationToken, "tokenInvalid");
    ...
    public async Task Erro_Sem_Token()
    {
        ...
        var response = await HttpHelper.DoDelete($"{_baseUrlAnexo}/{_anexoNovo.Id}", cancellationToken);
    ...
    public async Task Erro_Token_De_Usuario_Nao_Encontrado()
    {
        ...
        var response = await HttpHelper.DoDelete($"{_baseUrlAnexo}/{_anexoNovo.Id}", cancellationToken, token);
    ...
    public async Task Erro_App_Token_Ausente()
    {
        ...
        var response = await HttpHelper.DoDelete(url: $"{_baseUrlAnexo}/{_anexoNovo.Id}", token: token, cancellationToken: cancellationToken, addAppToken: false);
    ...
    public async Task Erro_App_Token_Invalido()
    {
        ...
        var response = await HttpHelper.DoDelete(url: $"{_baseUrlAnexo}/{_anexoNovo.Id}", token: token, cancellationToken: cancellationToken, appToken: "app-token-invalido");
